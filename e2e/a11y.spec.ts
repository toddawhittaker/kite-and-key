...
// a11y sweep — that's out of scope for this restyle) on the three pages the
// plan/UX-plan flag as the highest-risk boundary cases (UX plan §4: `Home`'s
// hero copy, `Projects`' body/meta text, `Partner`'s dark-hero rgba lede and
// stat tiles).
//
