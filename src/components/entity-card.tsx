 ...
 * Posts list items rather than building three bespoke components. `href` is
 * optional: only pass it when a real detail route exists (Projects). Without
 * it the card renders as a plain, non-interactive block instead of a link
 * to nowhere.
 */
